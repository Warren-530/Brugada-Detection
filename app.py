...
left, right = col_input, col_analysis = st.columns([4, 6])
...
pip install -U google-gena/* Wrap columns into cards */
[data-testid="column"] {
...
[data-testid="stFileUploadDropzone"] {
    border: 2px dashed #cbd0d9 !important;
...
with left:
    ...
    with st.expander("Clinical History", expanded=False):
        st.text_area(
            "Prior symptoms or clinical notes",
            key="clinical_history_input",
            placeholder="e.g., Syncope, family history of sudden cardiac death...",
        )
